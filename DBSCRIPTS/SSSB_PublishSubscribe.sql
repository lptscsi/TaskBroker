...
CREATE TABLE PPS.Subscriber (
	...
	CONSTRAINT PK_Subscriber PRIMARY KEY CLUSTERED ([SubscriberID])
);
GO
...
GO
CREATE NONCLUSTERED INDEX IX_Subscriber_ConversationHandle ON PPS.Subscriber([ConversationHandle]);
GO
